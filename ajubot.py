...
class Ajubot:
    ...
    def init_bot(self):
        ...
        dispatcher.add_handler(CallbackQueryHandler(self.confirm_assist, pattern="^assist.*"))
    ...
    def confirm_assist(self, update, context):
        ...
        for key, value in profile.items():
            if not value:
                ...
                if key == c.PROFILE_ACTIVITIES:
                    ...
                    self.confirm_assist(update, context)
                    return
